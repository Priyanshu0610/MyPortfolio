...
const coreStackIcons = [
  { name: "JavaScript", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#F7DF1E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z"/><path d="M9 9v6"/><path d="M15 9v6"/></svg> },
  { name: "React", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#61DAFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="12" rx="10" ry="4"/><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4" transform="rotate(120 12 12)"/></svg> },
  { name: "Next.js", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 8l8 8"/><path d="M16 8v8h-8"/></svg> },
  { name: "GSAP", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#88CE02" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
  { name: "Tailwind CSS", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#38B2AC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 14s2-3 4-3 3 2 4 2 2-3 4-3 3 2 4 2"/><path d="M4 18s2-3 4-3 3 2 4 2 2-3 4-3 3 2 4 2"/></svg> },
  { name: "HTML5", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E34F26" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4l1.5 14 6.5 2 6.5-2L20 4z"/><path d="M8 9h8l-.5 6-3.5 1-3.5-1"/></svg> },
  { name: "CSS3", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1572B6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4l1.5 14 6.5 2 6.5-2L20 4z"/><path d="M16 9H8l.5 6 3.5 1 3.5-1"/></svg> }
];

const philosophyWords = "Designing experiences that help brands grow through".split(" ");
...
export default function Home() {
  ...
  const disciplineGraphics = [
    // 0: Landing Pages
    (
      <motion.div key="0" initial={{ opacity: 0, scale: 0.8, rotate: -5 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} exit={{ opacity: 0, scale: 0.8 }} className="w-full h-full flex items-center justify-center absolute inset-0">
        <svg width="240" height="180" viewBox="0 0 240 180" fill="none" className="text-accent-blue drop-shadow-2xl">
          <rect x="10" y="10" width="220" height="160" rx="12" stroke="currentColor" strokeWidth="6" />
          ...
          <rect x="40" y="75" width="160" height="40" rx="4" fill="currentColor" fillOpacity="0.2" stroke="currentColor" strokeWidth="3" />
          <rect x="40" y="130" width="70" height="20" rx="4" fill="currentColor" fillOpacity="0.2" stroke="currentColor" strokeWidth="3" />
          <rect x="130" y="130" width="70" height="20" rx="4" fill="currentColor" fillOpacity="0.2" stroke="currentColor" strokeWidth="3" />
        </svg>
      </motion.div>
    ),
    // 1: Visual Branding
    (
      <motion.div key="1" initial={{ opacity: 0, scale: 0.8, rotate: 15 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} exit={{ opacity: 0, scale: 0.8 }} className="w-full h-full flex items-center justify-center absolute inset-0 relative">
        <motion.div animate={{ rotate: 180 }} transition={{ duration: 20, repeat: Infinity, ease: "linear" }} className="absolute">
          <svg width="200" height="200" viewBox="0 0 100 100" fill="none" className="text-accent-yellow drop-shadow-2xl">
            <circle cx="50" cy="20" r="20" fill="currentColor" />
            <rect x="15" y="50" width="40" height="40" fill="currentColor" fillOpacity="0.5" />
            <path d="M85 50 L105 90 L65 90 Z" fill="currentColor" fillOpacity="0.8" />
          </svg>
        </motion.div>
      </motion.div>
    ),
    // 2: Product Design
    (
      <motion.div key="2" initial={{ opacity: 0, scale: 0.8, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.8 }} className="w-full h-full flex items-center justify-center absolute inset-0">
        <svg width="140" height="260" viewBox="0 0 140 260" fill="none" className="text-accent-blue drop-shadow-2xl">
          <rect x="10" y="10" width="120" height="240" rx="20" stroke="currentColor" strokeWidth="8" />
          <path d="M50 10 H90" stroke="currentColor" strokeWidth="8" strokeLinecap="round" />
          <rect x="25" y="45" width="90" height="110" rx="8" fill="currentColor" fillOpacity="0.2" />
          <rect x="25" y="170" width="90" height="25" rx="6" fill="currentColor" fillOpacity="0.2" />
          <rect x="25" y="210" width="50" height="15" rx="4" fill="currentColor" fillOpacity="0.2" />
        </svg>
      </motion.div>
    )
  ];
  ...
  return (
    <main ref={container} className="relative min-h-screen">
      ...
      <section id="hero" className="h-screen w-full flex flex-col items-center justify-center relative overflow-hidden">
        ...
        >
          <svg viewBox="0 0 200 200" fill="none" className="w-16 md:w-24 h-auto group-hover:text-red-600 transition-colors duration-500">
      ...
      <section ref={section4YearsRef} className="min-h-screen w-full bg-[#202020] flex flex-col items-center justify-center relative overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center opacity-80 mt-[40vh] md:mt-[35vh]">
          <svg width="100%" height="600" viewBox="0 0 1000 600" fill="none" preserveAspectRatio="none">
            <motion.path
        ...
        >
          <svg width="80" height="80" viewBox="0 0 24 24" fill="white" className="opacity-80 drop-shadow-2xl">
        ...
        >
          <div className="bg-[#111] p-6 rounded-2xl border-[3px] border-[#FFE862] shadow-2xl flex items-center justify-center">
            <svg width="64" height="64" viewBox="0 0 38 57" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="z-10 text-center max-w-4xl px-6 text-white relative flex flex-col items-center">
          ...
          >
            <span className="font-bold">1+ years</span> of crafting<br />
            meaningful products and<br />
      ...
      <section className="py-24 w-full overflow-hidden bg-background relative flex flex-col gap-6 pointer-events-none">
          ...
          >
            ...
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex gap-8 items-center">
                {["BRAND DESIGNER", "WEB DESIGNER", "PRODUCT DESIGNER", "UX/UI EXPERT", "CREATIVE DIRECTOR"].map((role, idx) => (
                  <div key={idx} className="flex items-center gap-8">
                    <span className="text-5xl md:text-7xl font-sans font-bold tracking-tighter text-foreground">{role}</span>
        ...
        <div className="flex whitespace-nowrap w-fit">
          ...
          >
            {[...Array(2)].map((_, i) => (
              <div key={i} className="flex gap-8 items-center">
                {["VISUAL BRANDING", "MOTION GRAPHICS", "3D PROTOTYPING", "FRONTEND DEV", "TYPOGRAPHY"].map((role, idx) => (
                  <div key={idx} className="flex items-center gap-8 text-foreground">
                    <span className="text-5xl md:text-7xl font-sans font-black tracking-tighter text-transparent" style={{ WebkitTextStroke: "2px currentColor" }}>{role}</span>
      ...
      {/* Philosophy Section */}
      <section id="philosophy" className="min-h-[100vh] flex flex-col md:flex-row items-center justify-between px-10 md:px-24 py-32 max-w-[1600px] mx-auto w-full relative border-t border-black/10 dark:border-white/10">

        {/* Left Side: Rotating Badge Graphic */}
        <motion.div
          className="w-full md:w-1/2 h-[300px] md:h-[500px] flex justify-center items-center mb-20 md:mb-0 relative pointer-events-none"
        >
              ...
              >
                ...
                >
                  ...
                  <motion.svg
                    ...
                    width="140" height="140" viewBox="0 0 100 100" fill="none" className="text-accent-yellow drop-shadow-xl absolute"
                  >
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start md:items-end z-10 text-left md:text-right">
          ...
          <div className="flex flex-col items-start md:items-end text-4xl md:text-6xl lg:text-7xl font-sans uppercase font-black tracking-tighter">
            {["Landing Pages", "Visual Branding", "Product Design"].map((item, idx) => (
      ...
      <section id="about" className="min-h-screen py-32 px-6 md:px-12 max-w-[1600px] mx-auto border-t border-black/10 dark:border-white/10 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 relative z-10 w-full h-full pt-10">
          ...
          <div className="w-full lg:w-5/12 flex flex-col justify-center">
            ...
            >
              <p>
                I'm <strong className="font-medium text-foreground">Priyanshu Raj</strong>, a Frontend Developer and BCA student at Sarala Birla University (SBU) in Ranchi.
              </p>
              <p>
                I specialize in crafting visually stunning, responsive, and performance-optimized user interfaces. My expertise lies in bringing static designs to life using modern animation frameworks like GSAP and creating fluid, motion-rich scroll experiences.
              </p>
              <p>
                Most recently, I expanded my technical horizons through an <strong className="font-medium text-foreground">AI Web Development Internship</strong> with the Inamigos Foundation, bridging academic theory with cutting-edge industry practices.
              </p>
            </motion.div>
          </div>
          ...
          <div className="w-full lg:w-7/12 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h3 className="text-sm uppercase tracking-widest text-foreground/50 mb-8 font-bold">Core Stack</h3>
              <div className="flex flex-wrap gap-3 relative z-10">
                {coreStackIcons.map(skill => (
                  <span key={skill.name} className="bg-white dark:bg-[#2a2a2a] px-4 py-2 rounded-full text-sm font-medium shadow-sm border border-black/5 dark:border-white/5 flex items-center gap-2">
                    {skill.icon}
                    {skill.name}
                  </span>
                ))}
            ...
            >
              <h3 className="text-sm uppercase tracking-widest text-foreground/50 mb-6 font-bold">Systems & Logic</h3>
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-accent-blue/20 flex items-center justify-center text-accent-blue font-bold text-sm">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 9v6"/><path d="M15 12h6"/><path d="M11 9v6"/><path d="M8 12h6"/><path d="M5 18H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2"/></svg>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-accent-yellow/20 flex items-center justify-center text-[#d97743] font-bold text-sm">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 8H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h8a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-6a2 2 0 0 1-2-2v-4"/><path d="M16 16h2a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2H10a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4"/></svg>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-foreground/10 flex items-center justify-center text-foreground font-bold text-sm">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><path d="M18 9v6"/><path d="M6 9v12"/><path d="M6 9a9 9 0 0 0 9 9h3"/></svg>
                  </div>
            ...
            >
              ...
              >
                <svg width="200" height="200" viewBox="0 0 100 100" fill="none" className="text-foreground">
                  ...
                  <path d="M50 0 V100 M0 50 H100" stroke="currentColor" strokeWidth="1" />
                </svg>
              </motion.div>

              <div className="relative z-10 w-full flex justify-between items-start mb-8">
                <div>
                  <h3 className="text-xs uppercase tracking-[0.3em] text-foreground/50 mb-2 font-bold">Location</h3>
      ...
      <section id="projects" ref={projectsRef} className="py-16 md:py-32 px-6 md:px-12 max-w-[1600px] mx-auto border-t border-black/10 dark:border-white/10 relative">
        ...
        <div className="flex flex-col gap-32 md:gap-48 relative z-10 w-full">
          {projects.slice(0, 4).map((project, idx) => {
            ...
            return (
              <div key={idx} className={`w-full flex ${isEven ? 'justify-start md:pl-[10%]' : 'justify-end md:pr-[10%]'}`}>
                <Link href={`/works/${project.slug}`} className="w-full max-w-xl md:max-w-2xl">
                  {/* Postage Stamp Card Wrapper */}
                  <motion.div
                    initial={{ opacity: 0, scale: 0.85, y: 50, rotate: isEven ? -3 : 3 }}
                    whileInView={{ opacity: 1, scale: 1, y: 0, rotate: isEven ? -1 : 1 }}
                    whileHover={{ scale: 1.05, rotate: 0 }}
                    viewport={{ once: true, margin: "-25%" }}
                    transition={{ duration: 0.8, type: "spring", bounce: 0.4 }}
                    className="p-4 bg-white dark:bg-[#2a2a2a] relative group shadow-2xl"
                    style={{
                      WebkitMaskImage: "linear-gradient(black, black), radial-gradient(circle at center, transparent 6px, black 6.5px)",
                      WebkitMaskSize: "calc(100% - 12px) calc(100% - 12px), 20px 20px",
                      WebkitMaskPosition: "center, -10px -10px",
                      WebkitMaskRepeat: "no-repeat, repeat",
                      maskImage: "linear-gradient(black, black), radial-gradient(circle at center, transparent 6px, black 6.5px)",
                      maskSize: "calc(100% - 12px) calc(100% - 12px), 20px 20px",
                    ...
                    <div className="p-4 md:p-6 bg-[#faf9f6] dark:bg-[#1a1a1a] h-full w-full flex flex-col items-center overflow-hidden border-[1.5px] border-black/10 dark:border-white/10">
                      ...
                      <div className="w-full aspect-[4/3] relative overflow-hidden bg-black/5 mb-6 transition-shadow group-hover:shadow-inner">
                        ...
                        <div className="absolute top-4 -right-4 w-24 h-24 border-[3px] border-accent-blue/40 rounded-full flex items-center justify-center -rotate-12 opacity-50 mix-blend-multiply dark:mix-blend-screen group-hover:rotate-6 transition-transform duration-700 pointer-events-none">
                          <span className="text-[0.6rem] font-bold text-accent-blue uppercase tracking-widest text-center leading-tight">Authentic<br/>{project.year}</span>
                        </div>
                      </div>

                      {/* Content */}
                      <div className="w-full text-center">
                        <h3 className="text-3xl md:text-5xl font-playfair font-black mb-3 uppercase tracking-tighter text-foreground">{project.title}</h3>
                        <div className="text-xs font-bold tracking-[0.2em] text-foreground/50 uppercase">{project.category}</div>
                      </div>
                    </div>
                  </motion.div>
                </Link>
